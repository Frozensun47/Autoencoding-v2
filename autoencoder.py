...
# Encoder
conv = Conv2D(8, kernel_size=(3, 3), activation='LeakyReLU',
              padding='same')(input_img)
bn1 = BatchNormalization()(conv)
conv1 = Conv2D(16, kernel_size=(3, 3),
               strides=(2, 2), activation='LeakyReLU', padding='same')(bn1)  # 128
bn2 = BatchNormalization()(conv1)
conv2 = Conv2D(32, kernel_size=(3, 3),
               strides=(2, 2), activation='LeakyReLU', padding='same')(bn2)  # 256
bn3 = BatchNormalization()(conv2)
conv3 = Conv2D(64, kernel_size=(3, 3),
               strides=(2, 2), activation='LeakyReLU', padding='same')(bn3)  # 512
bn4 = BatchNormalization()(conv3)
conv4 = Conv2D(64, kernel_size=(3, 3),
               strides=(2, 2), activation='LeakyReLU', padding='same')(bn4)  # 1024


# Decoder
up = UpSampling2D(size=(2, 2))(conv4)
conv5 = Conv2D(64, kernel_size=(3, 3), activation='LeakyReLU',
               padding='same')(up)  # 512
bn5 = BatchNormalization()(conv5)
add1 = Add()([conv3, bn5])
conv6 = Conv2D(64, kernel_size=(3, 3),
               activation='LeakyReLU', padding='same')(add1)  # 512
bn6 = BatchNormalization()(conv6)

up1 = UpSampling2D(size=(2, 2))(bn6)
conv7 = Conv2D(32, kernel_size=(3, 3), activation='LeakyReLU',
               padding='same')(up1)  # 256
bn7 = BatchNormalization()(conv7)
add2 = Add()([conv2, bn7])
conv8 = Conv2D(32, kernel_size=(3, 3),
               activation='LeakyReLU', padding='same')(add2)  # 256
bn8 = BatchNormalization()(conv8)

up2 = UpSampling2D(size=(2, 2))(bn8)
conv9 = Conv2D(16, kernel_size=(3, 3), activation='LeakyReLU',
               padding='same')(up2)  # 128
bn9 = BatchNormalization()(conv9)
# add3 = Add()([conv1, bn9])
conv10 = Conv2D(16, kernel_size=(3, 3),
                activation='LeakyReLU', padding='same')(bn9)  # 128
bn10 = BatchNormalization()(conv10)

up3 = UpSampling2D(size=(2, 2))(bn10)
conv11 = Conv2D(8, kernel_size=(3, 3), activation='LeakyReLU',
                padding='same')(up3)  # 64
bn11 = BatchNormalization()(conv11)
# add4 = Add()([conv, bn11])
conv12 = Conv2D(8, kernel_size=(3, 3),
                activation='LeakyReLU', padding='same')(bn11)  # 64
bn12 = BatchNormalization()(conv12)

output_img = Conv2D(3, kernel_size=(
    1, 1), activation='LeakyReLU', padding='same')(bn12)
